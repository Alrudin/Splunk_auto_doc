...
def test_migration():
    ...
    try:
        ...
        ingestion_runs_columns = [col["name"] for col in inspector.get_columns("ingestion_runs")]
        ...
        expected_files_columns = ["id", "run_id", "path", "sha256", "size_bytes", "stored_object_key"]
        ...
        if files_fks:
            print(f"  ✓ Foreign key to ingestion_runs exists")
        else:
            print(f"  ✗ Foreign key missing!")
            return False
