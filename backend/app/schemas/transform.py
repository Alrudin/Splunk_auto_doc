...
class TransformResponse(BaseModel):
    ...
    writes_meta_index: bool | None = Field(None, description="Whether transform writes to _MetaData:Index")
    writes_meta_sourcetype: bool | None = Field(None, description="Whether transform writes to _MetaData:Sourcetype")
